...
#SBATCH --output=logs_train_T1/train_fold1_%j.out
#SBATCH --error=logs_train_T1/train_fold1_%j.err
...
# Run script 
nnUNetv2_train Dataset003_Brain_T1 3d_fullres 1 -p nnUNetPlans  
